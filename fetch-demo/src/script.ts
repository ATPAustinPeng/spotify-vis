...
async function fetchRecommendations(token: string): Promise<Recommendations> {
    const result = await fetch("https://api.spotify.com/v1/recommendations?limit=1&market=us&" +
        "seed_artists=4NHQUGzhtTLFvgF5SZesLK&seed_genres={classical,country}&seed_tracks=0c6xIDDpzE81m2q797ordA", {
        method: "GET",
